        ...
        <div class="row">
            <div class="col-lg-6 my-2">
                ...
                <form action="">
                    ...
                    <input type="text" class="form-control my-2" placeholder="Your Phone">
                    <input type="text" class="form-control my-2" placeholder="Your Email">
                    <input type="text" class="form-control my-2" placeholder="Subject">
                    <textarea name=""  class="form-control my-2" id="" cols="30" rows="10">Message</textarea>
